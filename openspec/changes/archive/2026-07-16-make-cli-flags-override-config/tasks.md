...
- [x] 1.1 In `main.go`, rewrite the body of `resolveWatchList`
...
- [x] 1.2 Update the docstring above `resolveWatchList` to describe
...
- [x] 2.1 In `discovery_test.go`, replace
...
- [x] 2.2 In `discovery_test.go`, delete
...
- [x] 2.3 In `discovery_test.go`, leave
...
- [x] 3.1 Run `go test -timeout 30s ./...` and confirm every test
...
- [x] 3.2 Run `go vet ./...` and confirm clean output.
- [x] 3.3 Run `gofmt -l .` and confirm no files need reformatting.
- [x] 3.4 Run `openspec validate make-cli-flags-override-config`
