...
### Requirement: Configuration selects custom workflows
...
### Requirement: Watcher creates or resumes a workflow-specific persistent lane
...
### Requirement: Watcher rolls back only the failed workflow attempt
